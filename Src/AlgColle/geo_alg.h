...
//	static void FillHoles(Eigen::MatrixXd& vertexs, Eigen::MatrixXi& faces);
	...
	static bool ComputeClosestPointOfTwoSegments(std::pair<OpenMesh::Vec3d, OpenMesh::Vec3d>sega, std::pair<OpenMesh::Vec3d, OpenMesh::Vec3d>segb, OpenMesh::Vec3d&res_pa, OpenMesh::Vec3d &res_pb);//if they are paralle return false
	...
	static void SimplifyMesh(Eigen::MatrixXi & faces, Eigen::MatrixXd &vertexs, double tgt_face_num, Eigen::MatrixXi &res_faces, Eigen::MatrixXd &res_vertexs);
	static void SimplifyMesh(COpenMeshT &mesh,int face_num);
