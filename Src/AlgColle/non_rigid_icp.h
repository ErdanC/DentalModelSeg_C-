...
protected:
	...
	Eigen::MatrixXd template_crown_vertexs_;
	Eigen::MatrixXd tempalte_crown_vertex_normals_;
	Eigen::MatrixXi tempalte_crown_faces_;
...
public:
	...
	CNonRigidICP(COpenMeshT *src_mesh, COpenMeshT *template_crown_mesh, COpenMeshT* tgt_mesh, CNonRigidICPParams params = CNonRigidICPParams());
	CNonRigidICP(COpenMeshT *src_mesh, COpenMeshT* tgt_mesh, CNonRigidICPParams params = CNonRigidICPParams());
	//static void nonRigidICP(COpenMeshT *src_mesh, COpenMeshT *template_crown_mesh, COpenMeshT* tgt_mesh, CNonRigidICPParams params = CNonRigidICPParams());
	void InitSrcToTgtScale(COpenMeshT *src_mesh, COpenMeshT* tgt_mesh);
