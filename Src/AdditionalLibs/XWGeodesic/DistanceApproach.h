...
protected:
	...
	string m_nameOfAlgorithm;
	 std::int64_t m_maxLenOfQueue;
	 std::int64_t m_depthOfResultingTree;
	
	 std::int64_t m_nTotalMilliSeconds;
protected:
...
public:
	...
	virtual  std::int64_t GetMaxLenOfQueue() const{return m_maxLenOfQueue;}
	virtual  std::int64_t GetMaxPropagationLevels()const {return m_depthOfResultingTree;}
	string GetAlgorithmName() const;
	 std::int64_t GetRunTime() const{return m_nTotalMilliSeconds;}
