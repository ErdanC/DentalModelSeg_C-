...
{
	auto mesh_obj_pool= CUIContext::manager_context_.GetDataPool().GetMeshObjectPool();
	...
	auto curve_obj_pool = CUIContext::manager_context_.GetDataPool().GetCurveObjectPool();
