#ifndef CAUTO_HARMONIC_FIELD_SEGMENTATION_ACTION_H
#define CAUTO_HARMONIC_FIELD_SEGMENTATION_ACTION_H
...
#include<vector>
class CAutoHarmonicFieldSegmentation :public CActionBase
{
protected:
	///////////////test auto/////////////////////////////
	...
	bool is_picking_feature_ = false;
...
public:
	CAutoHarmonicFieldSegmentation();
};
#endif
